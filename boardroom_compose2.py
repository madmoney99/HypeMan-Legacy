...
def defaultCompose(options):
    ...
    fg = cv2.imread('Images/fg_mask_rob.png',0)
    ret, fgmask = cv2.threshold(fg, 1, 255, cv2.THRESH_BINARY)
    fgmask_inv = cv2.bitwise_not(fgmask)
    combined = cv2.bitwise_and(combined,combined,mask=fgmask_inv)
    fgimg = cv2.bitwise_and(bg,bg,mask=fgmask)
...
backgroundImage = 'Images/boardroom 01.jpg'
squadron = ''
import shutil
import sys
...
if len(sys.argv)>= 2:
    ...
    if str(sys.argv[1]) == 'turkey':
        airframe = 'F-14B'
        backgroundImage = 'Images/boardroom 02.jpg'
        ...
        airframe = 'A-4E-C'
        backgroundImage = 'Images/boardroom_03.jpg'
    elif str(sys.argv[1]) == 'goshawk':
        airframe = 'T-45'
        backgroundImage = 'Images/boardroom T45.jpg' 
        #shutil.copy2('board.png', 'final.jpg')
        #sys.exit()			  
    elif str(sys.argv[1]) == 'harrier':
        airframe = 'AV8BNA'        
        backgroundImage = 'Images/boardroom AV8.jpg'
...
if squadron == '':
    ...
    options['backgroundImage']='Images/86greenieboard.jpg'
    options['emblem'] = 'Images/86greenieboard_emblem.png'
    options['frame'] = 'Images/86greenieboard_frame.png'
    options['mask'] = 'Images/86greenieboard_frame_mask.png'

    vfa86Compose(options)
elif squadron == 'vf211':
    print('vf211')
    options['backgroundImage']='Images/211greenieboard.jpg'
    options['emblem'] = 'Images/211greenieboard_emblem.png'
    options['frame'] = 'Images/86greenieboard_frame.png'
    options['mask'] = 'Images/86greenieboard_frame_mask.png'
